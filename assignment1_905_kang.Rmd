...
3. `stage_4`에서 대략 절반정도 되는 gene들의 expression rate이 가장 높다. 따라서 이 시기에 development가 가장 활발하게 일어난다고 생각해볼 수 있다.

4. `stage_5`에서 전체적으로 expression rate이 낮아지는 패턴이 보인다. `stage_5`는 태어나기 바로 전 stage이므로, development가 거의 다 되었기 때문에 많이 expression되지 않는 것으로 생각해볼 수 있다.
...
가장 많이 expression되는 세 가지 gene에 대해 간략하게 조사해보았습니다.
...
* TMSB10은 *Homo sapiens thymosin beta 10*으로, mutation 시 breast cancer와 lung cancer에 연관성이 있습니다. Human brain development 시 신경모세포종에서 레티노익산의 조절을 받습니다.  
...
Mutation 시 청각손실을 일으키는 ACTG1은 `stage_2A`에서 가장 많이 expression됩니다. 이는 DFC 내 청각과 관련된 부분이 다른 부분들보다 일찍 발달한다는 의미가 아닐까 생각합니다.  
TMSB10과 TUBA1A는 `stage_4`에서 가장 많이 expression되는데, 이 둘은 brain development와 직접적인 연관성이 있다고 연구된 gene들입니다. 특히 TUBA1A는 mutation이 일어났을 시 뇌에 주름이 생기지 않는 lissencephaly의 원인이 되는 gene입니다. 따라서 `stage_4`는 앞에서 언급했던 것처럼 development가 가장 활발하게 일어나는 중요한 시기라고 생각됩니다.
